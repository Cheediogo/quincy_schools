...
const DashboardItem = () => {
  ...
  return (
    <Row className='green-bg px-4 text-white dashy-height'>
        <Col md={6} sm={12} className=' align-self-center flex-column'>
          <h2 className='Dash-font fw-bold'>Welcome <br></br>{user?.displayName? user.displayName: localStorage.getItem("name")}</h2>
